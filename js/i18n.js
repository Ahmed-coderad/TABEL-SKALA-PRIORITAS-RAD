...
const TRANSLATIONS = {
  ...
  id: {
    ...
    reminderHint: "Notifikasi akan berbunyi seperti panggilan telepon pada waktu ini, mengikuti tanggal & jam perangkatmu.",
  ...
  en: {
    ...
    reminderHint: "The notification will ring like an incoming call at this time, based on your device's date and clock.",
  ...
  ms: {
    ...
    reminderHint: "Notifikasi akan berbunyi seperti panggilan telefon pada masa ini, mengikut tarikh & jam peranti anda.",
  ...
  jv: {
    ...
    reminderHint: "Notifikasi bakal muni kaya telpon mlebu ing wektu iki, miturut tanggal & jam piranti sampeyan.",
    categoryLabel: "Kategori Prioritas",
  ...
  su: {
    ...
    datePlaceholder: "Pilih tanggal",
    reminderLabel: "Alarm Pangeling (opsional)",
    reminderHint: "Notifikasi bakal disada kawas telepon asup dina waktu ieu, nuturkeun tanggal & jam alat anjeun.",
    categoryLabel: "Kategori Prioritas",
