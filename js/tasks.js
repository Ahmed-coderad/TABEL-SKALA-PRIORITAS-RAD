...
function addTask(){
  ...
  // "Project Tabel Skala Prioritas" wajib diisi sebelum aktivitas apa
  // pun bisa ditambahkan — dicek ulang di sini (bukan cuma lewat
  // atribut disabled di DOM) sebagai lapis pertahanan kedua.
  if(typeof requirePlannerNameOrBlock === 'function' && !requirePlannerNameOrBlock()){
    return;
  }
